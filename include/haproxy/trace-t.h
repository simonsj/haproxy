...
#define TRC_ARG1_HXSTRM (TRC_ARG_HXSTRM << 0)
...
#define TRC_ARG2_HXSTRM (TRC_ARG_HXSTRM << 8)
...
#define TRC_ARG3_HXSTRM (TRC_ARG_HXSTRM << 16)
...
#define TRC_ARG4_HXSTRM (TRC_ARG_HXSTRM << 24)
...
#define TRC_ARGS_HXSTRM (TRC_ARG_HXSTRM * 0x01010101U)
